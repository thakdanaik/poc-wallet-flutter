...
class MyApp extends StatelessWidget {
  ...
  final List<CardData> _cardData = [
    ...
    CardData(name: 'Beer Shop', cardNo: 'xxxxxx-9999', cardColor: Colors.yellow),
    ...
    CardData(name: 'Bread Shop', cardNo: 'xxxxxx-9999', cardColor: Colors.brown),
    CardData(name: 'Barber Shop', cardNo: 'xxxxxx-9999', cardColor: Colors.black),
